use ecosphere::instr::{FuncBuilder, Instr, Val};
...
fn main() {
    ...
    func.with_block(b1);
    let i1 = func.push_instr(Instr::Alloc(Val::Const())); // const 1
    let i2 = func.push_instr(Instr::Alloc(Val::Const())); // const 1
    let i3 = func.push_instr(Instr::Alloc(Val::Const())); // const 0
    let b2 = func.push_block();
    func.push_instr(Instr::Br(Val::Const(), b2, b2)); // const true
    func.with_block(b2);
    ...
    let i9 = func.push_instr(Instr::Op(add(), vec![Val::Instr(i1), Val::Const()]));
    // const 1
